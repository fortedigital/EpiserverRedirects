...
namespace Forte.EpiserverRedirects.Tests.Unit.DynamicData
{
    ...
    {
        private readonly IRedirectRuleMapper<RedirectRule> _target;
        private readonly Identity _entityId;
        private readonly RedirectRule _entity;
        ...
        public DynamicDataRedirectRuleMapperTest()
        {
            ...
            _entityId = Identity.NewIdentity();
            _entity = new RedirectRule
            {
                Id = _entityId,
                ContentId = 1111,
        ...
        public void Given_Rule_MapForUpdate_MapsCorrectly()
        {
            ...
            Assert.Equal(_entityId, _entity.Id);
